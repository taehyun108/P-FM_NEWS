...
CATEGORY_RULES: dict[str, list[str]] = {
    ...
    "정부/정책·법령": ["법안", "법률안", "규제", "국회", "산업부", "환경부", "기재부", "공정위",
                       "보조금", "특화단지", "특별법", "IRA", "관세", "인허가", "과징금", "제재",
                       "예비타당성", "예타", "국정감사", "입법"],
    "지역": POSCO_REGIONS,
...
def cmd_selftest() -> int:
    ...
    check("'정부' 단독은 정책 태그 아님",
          "정부/정책·법령" in detect_categories("정부 관계자 만난 수출입은행"), False)
    check("구체 용어는 정책 태그",
          "정부/정책·법령" in detect_categories("특화단지 지정 법안 국회 통과"), True)
